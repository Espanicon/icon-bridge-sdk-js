...
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'balanceOf(_owner, _coinName)'", () => {
...
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'balanceOfBatch(_owner, _coinNames)'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'coinNames()'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'feeRatio(_coinName)'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'getAccumulatedFees()'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'getOwners()'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'isOwner()'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'name()'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'getTokenLimit(_name)'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'getTokenLimitTxn(_Sn)'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'getSn(_Sn)'", () => {
  it("Returns Sn.", async () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'isUserBlackListed(_net, _address)'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'getBlackListedUsers(_net, _start, _end)'", () => {
...
// Icon chain.
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'getRegisteredTokensCount()'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'tokenLimitStatus(_net, _coinName)'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'blackListedUsersCount(_net)'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'getTransaction(_sn)'", () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'isRestrictionEnabled()'", () => {
  it("Returns transaction.", async () => {
...
// It should returns and object with a predefined set of keys.
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'coinId(_coinName)'", () => {
...
// one key named 'error'
describe.skip("E2E testing Icon Bridge SDK. Chain: 'icon', Method 'balanceOf(_owner, _coinName)' with a wrongly formatted wallet address.", () => {
