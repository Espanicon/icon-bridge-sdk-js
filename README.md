[![GitHub license](https://badgen.net/github/license/Espanicon/icon-bridge-sdk-js)](https://github.com/Espanicon/icon-bridge-sdk-js/blob/master/LICENSE.md) [![TypeScript](https://badgen.net/badge/icon/typescript?icon=typescript&label)](https://typescriptlang.org)
...
This SDK allows developers to easily integrate the ICON Bridge into their applications written in the Javascript programming language.
